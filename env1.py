...
class MazeEnv():
    def __init__(self, maze_size, outer_wall_gap, inner_wall_gap, wall_thickness):
        ...
        t[outer_partition-wall_thickness:outer_partition, 0:outer_partition] = 1

        # building inner walls
        t[partition:inner_partition, partition*2:partition*2+wall_thickness] = 1
